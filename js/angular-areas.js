    ...
    return {
        ...
        controller : function ($scope, $element, $attrs) {
            ...
            $scope.imageArea = function (parent, areaid) {
                ...
                var updateResizeHandlers = function (show) {
                ...
                var updateBtDelete = function (visible) {
                    if ($btDelete) {
                        $btDelete.css({
                ...
                var updateCursor = function (cursorType) {
                    $outline.css({
                        cursor: cursorType
                    });
                ...
                var pickSelection = function (event) {
                    cancelEvent(event);
                    focus();
                ...
                var pickResizeHandler = function (event) {
                    cancelEvent(event);
                    focus();
                ...
                var resizeSelection = function (event) {
                    cancelEvent(event);
                    focus();
                ...
                var releaseSelection = function (event) {
                    cancelEvent(event);
                    off("move", "stop");
                ...
                var getElementOffset = function (object) {
